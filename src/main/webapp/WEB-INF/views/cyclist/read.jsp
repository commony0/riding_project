...
window.onload = function() {
    ...
    // document.getElementById('passwd2').addEventListener('keypress', (event) => {
      if(event.key === 'Enter') {
  ...
  function checkID() {
    ...
    if (id.value.trim().length == 0) {
      ...
      $.ajax({
        url: './checkID.do', // spring execute, http://localhost:9091/cyclist/checkID.do?id=user1@gmail.com
        type: 'get',  // post
      ...
      // 처리중 출력
      id_msg.innerHTML="<img src='/cyclist/images/ani04.gif' style='width: 6%;'>"; // static 기준
...
<c:import url="/menu/top.do" />
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' class="">
    ...
    <div class="form-group"> <%-- 줄이 변경되지 않는 패턴 --%>
      <label>아이디*:
        <input type='text' class="form-control form-control-sm" name='id' id='id' value='${cyclistVO.id }' required="required" placeholder="아이디*" autofocus="autofocus">
      </label>
    ...
    <div class="form-group"> <%-- label의 크기에따라 input 태그의 크기가 지정되는 형태 --%>
      <label>성명*:
        <input type='text' class="form-control form-control-sm" name='mname' id='mname' value='${cyclistVO.mname }' required="required" placeholder="성명">
      </label>
    ...
    <div class="form-group"> <%-- label의 크기에따라 input 태그의 크기가 지정되는 형태, 줄이 변경되지 않는 패턴 --%>
      <label>전화 번호:
        <input type='text' class="form-control form-control-sm" name='tel' id='tel' value='${cyclistVO.tel }' required="required" placeholder="전화번호">
      </label>
      예) 010-0000-0000
    </div>   
    ...
    <div class="form-group"> <%-- 줄이 변경되지 않는 패턴 --%>
      <label>우편 번호:
        <input type='text' class="form-control form-control-sm" name='zipcode' id='zipcode' value='${cyclistVO.zipcode }' placeholder="우편번호">
      </label>
    ...
    <div class="form-group">
      ...
      <input type='text' class="form-control form-control-sm" name='address1' id='address1' value='${cyclistVO.address1 }' placeholder="주소">
    </div>   

    <div class="form-group">
      <label style="width: 100%;">상세 주소:</label>
      <input type='text' class="form-control form-control-sm" name='address2' id='address2' value='${cyclistVO.address2 }' placeholder="상세 주소">
    </div>   

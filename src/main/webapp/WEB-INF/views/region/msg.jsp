...
%>
<div class='title_line'>지역 > 알림</div>
<div class='message'>
  <fieldset class='fieldset_basic'>
    <ul>
        ...
        %>
          <li class="li_none">
            <span class="span_success">지역를 등록했습니다.</span><br>
            등록된 지역: <%=name %>
          </li>
        ...
        %>
          <li class="li_none">
            <span class="span_fail">지역 등록에 실패했습니다.</span><br>
            등록 실패된 지역: <%=name %>
          </li>
        <%  
        } else if(code.equals("update_success")){
          %>  
          <li class="li_none"><span class="span_success">카테고리를 수정하였습니다.</span><br>
          수정된 카테고리: <%=name %>
          </li>
        <%
        } else if(code.equals("update_fail")){
        %> 
          <li class="li_none"><span class="span_fail">카테고리 수정에 실패하였습니다.</span><br>
          수정 실패된 카테고리: <%=name %>
          </li> 
        <%
        } else if(code.equals("delete_success")){
          %>  
          <li class="li_none"><span class="span_success">카테고리를 삭제하였습니다.</span><br>
          삭제된 카테고리: <%=name %>
          </li>
        <%
        } else if(code.equals("delete_fail")){
        %> 
          <li class="li_none"><span class="span_fail">카테고리 삭제에 실패하였습니다.</span><br>
          삭제 실패된 카테고리: <%=name %>
          </li> 
        <%
        } 

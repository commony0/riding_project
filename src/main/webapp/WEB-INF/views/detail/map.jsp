...
<DIV class='title_line'><A href="/detail/list_by_regionno.do?regionno=${regionVO.regionno }" class="title_link">${regionVO.name }</A> > ${detailVO.title } > 지도 등록/수정/삭제</DIV>
  ...
  <FORM name='frm_map' method='post' action='./map.do'>
    ...
    <div>
       <label>지도 스크립트</label>
       <textarea name='map' class="form-control" rows="12" style='width: 100%;'>${detailVO.map }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/detail/images/map01.jpg' style='width: 60%;'><br><br>
      <IMG src='/detail/images/map02.jpg' style='width: 60%;'><br><br>
      <IMG src='/detail/images/map03.jpg' style='width: 60%;'><br><br>
      <IMG src='/detail/images/map04.jpg' style='width: 60%;'><br><br>
      <IMG src='/detail/images/map05.jpg' style='width: 60%;'><br>
  </DIV>

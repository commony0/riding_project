...
public class Tool {
  ...
  public static synchronized String getOSPath() {
      ...
      if (File.separator.equals("\\")) {
          // Windows 개발시 사용 폴더
          // path="C:\\kd\\ws_java\\riding_v3sbm3c\\src\\main\\resources\\static";
          
          // Windows 배포, 폴더 생성
          path = "C:/kd/deploy/riding_v3sbm3c";

      } else {
          // Linux 배포
          // 기본 명령어
          // pwd: 현재 경로 확인, mkdir deploy: 폴더 생성, cd deploy: 폴더 이동, rmdir riding_v3sbm3c: 폴더 삭제, cd ..: 상위 폴더로 이동 
          path = "/home/ubuntu/deploy/riding_v3sbm3c";
      }
      // System.out.println("path: " + path);
